...
public class TestListener extends BaseTest implements ITestListener {
    ...
    public void onTestSuccess(ITestResult iTestResult) {
        System.out.println("I am in onTestSuccess method " +  getTestMethodName(iTestResult) + " succeess");
        //Extentreports log operation for passed tests.
    //   String base64Screenshot = "data:image/png;base64,"+((TakesScreenshot)driver).getScreenshotAs(OutputType.BASE64);
        //ExtentTestManager.getTest().log(LogStatus.PASS,"Enter successful ");//, ExtentTestManager.getTest().addBase64ScreenShot(base64Screenshot));
    }
